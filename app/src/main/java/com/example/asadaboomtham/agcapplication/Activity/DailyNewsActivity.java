...
public class DailyNewsActivity extends AppCompatActivity implements NewsAdapter.ContactsAdapterListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private static final String URL = "http://10.105.1.250/reddit/dailynews_data0.php";
